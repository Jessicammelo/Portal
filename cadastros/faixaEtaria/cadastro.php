...
if (!empty($_POST['16_24']) && !empty($_POST['25_29']) && !empty($_POST['30_39']) && 
...
<form class=" col-6 container" method="POST">
        <div class="form-group">
            ...
            <input name="16_24" class="form-control" placeholder="Digite valor">
        </div>
        <div class="form-group">
            <label>25 á 29 anos</label>
            <input name="25_29" class="form-control" placeholder="Digite valor">
        </div>
        <div class="form-group">
            <label>30 á 39 anos</label>
            <input name="30_39" class="form-control" placeholder="Digite valor">
        </div>
        <div class="form-group">
            <label>40 á 49 anos</label>
            <input name="40_49" class="form-control" placeholder="Digite valor">
        </div>
        <div class="form-group">
            <label>50 anos</label>
            <input name="_50" class="form-control" placeholder="Digite valor">
        </div>
